...
\ \((_)/ /(_)_\(_)/ __||_ _| |  \/  | 
 \ \/\/ /  / _ \  \__ \ | |  | |\/| | 
  \_/\_/  /_/ \_\ |___/|___| |_|  |_| 
	...
	###########nochange🥀#########
	os.system('espeak -a 300 " this tool gift by team-BOT HACKER"')
 ###############❎ ##############
def login():
	
	os.system("clear")
	cookie = input(f"\x1b[38;5;196m LOGIN FRASH COOKIE  :>\x1b[38;5;46m ")
	...
	try:
		...
		cetak(nel(f'\x1b[38;5;196m [!] LOGIN FILD...TRY AGAIN !!!'))
		os.system('espeak -a 300 " Login fild"')
		login()
...
{P2} TODAY Date    :   {hari}, {tanggal}''',title=f'{P2} {H2}[ {P2}Your Information {H2}]',subtitle_align='left',padding=1,style='blue'))
	...
	os.system('espeak -a 300 " auto shear limit"')
	...
	try:
		...
		for x in range(jumlah):
			...
			if "id" in post:
				...
				print(f'{P}\r   └──> Time {bas} Shear send {H}{n}{P}  {N} ',end='');sys.stdout.flush()
